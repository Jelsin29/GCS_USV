...
class UserMenu(QWidget):
    ...
    def __init__(self, id, name, pixmap, location, parent=None):
        ...
        self.authority_button = QPushButton("Grant Authority")
    ...
    def giveAuthority(self):
        if self.authority_button.text() == "Grant Authority":
            self.authority_button.setText("Revoke Authority")
            self.parent.firebase.update_user_authority(True, self.id + 1)
        else:
            self.authority_button.setText("Grant Authority")
