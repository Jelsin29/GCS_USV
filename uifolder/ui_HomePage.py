...
"}")
    ...
    def retranslateUi(self, HomePage):
        ...
        self.modes_comboBox.setItemText(0, QCoreApplication.translate("HomePage", u"Select Map Mode", None))
        self.modes_comboBox.setItemText(1, QCoreApplication.translate("HomePage", u"Marker Mode", None))
        self.modes_comboBox.setItemText(2, QCoreApplication.translate("HomePage", u"Area Selection Mode", None))
        self.modes_comboBox.setItemText(3, QCoreApplication.translate("HomePage", u"Waypoint Mode", None))

        self.btn_chooseMode.setText(QCoreApplication.translate("HomePage", u"Select Mode", None))
        self.btn_setMission.setText(QCoreApplication.translate("HomePage", u"Define Mission", None))
        self.btn_undo.setText(QCoreApplication.translate("HomePage", u"Undo", None))
        self.btn_clearAll.setText(QCoreApplication.translate("HomePage", u"Clear All", None))
        self.btn_antenna.setText(QCoreApplication.translate("HomePage", u"Antenna Tracking", None))
        self.btn_startMission.setText(QCoreApplication.translate("HomePage", u"Start Mission", None))
        self.btn_abort.setText(QCoreApplication.translate("HomePage", u"Abort Tracking", None))
        self.btn_rtl.setText(QCoreApplication.translate("HomePage", u"Return Home", None))
        ...
        self.btn_move.setText(QCoreApplication.translate("HomePage", u"Go to Point", None))
        self.btn_track_all.setText(QCoreApplication.translate("HomePage", u"Track What You See", None))
        self.btn_land.setText(QCoreApplication.translate("HomePage", u"Land", None))
        self.btn_rtl_2.setText(QCoreApplication.translate("HomePage", u"Return Home", None))
        self.btn_set_roi.setText(QCoreApplication.translate("HomePage", u"Set ROI", None))
        self.btn_cancel_roi.setText(QCoreApplication.translate("HomePage", u"Cancel ROI", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.guided), QCoreApplication.translate("HomePage", u"Guided", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.Console), QCoreApplication.translate("HomePage", u"Console", None))
    # retranslateUi
