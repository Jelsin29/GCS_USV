...
"   ")
        ...
        self.Speedometer = QFrame(self.mainWidget)
        ...
        self.Speedometer.setMinimumSize(QSize(300, 300))
        self.Speedometer.setMaximumSize(QSize(350, 350))
        ...
        self.speed_label.setGeometry(QRect(22, 22, 256, 256))
        ...
        self.speed_needle.setGeometry(QRect(22, 22, 256, 256))
        ...
        self.speed_text.setGeometry(QRect(140, 230, 60, 30))
        ...
        self.mainHorizontalLayout.addWidget(self.Speedometer)

        self.Direction = QFrame(self.mainWidget)
        ...
        self.Direction.setMinimumSize(QSize(300, 300))
        self.Direction.setMaximumSize(QSize(350, 350))
        ...
        self.direction_label.setGeometry(QRect(22, 22, 256, 256))
        ...
        self.direction_needle.setGeometry(QRect(22, 22, 252, 252))
        ...
        self.mainHorizontalLayout.addWidget(self.Direction)
        ...
        sizePolicy3.setHeightForWidth(self.telemetryContainer.sizePolicy().hasHeightForWidth())
        self.telemetryContainer.setSizePolicy(sizePolicy3)
        self.telemetryContainer.setMinimumSize(QSize(400, 480))
        self.telemetryContainer.setMaximumSize(QSize(450, 16777215))
