...
class Ui_TargetsPage(object):
    ...
    def retranslateUi(self, TargetsPage):
        ...
        self.label.setText(QCoreApplication.translate("TargetsPage", u"Detected Targets", None))
        self.label_2.setText(QCoreApplication.translate("TargetsPage", u"Mobile App Connections", None))
    # retranslateUi
